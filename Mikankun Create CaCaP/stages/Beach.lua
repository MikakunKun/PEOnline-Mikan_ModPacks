function onCreate()
	...
	makeLuaSprite('BeachSky', 'stages/vee-funkin/BeachSky', -1600, -200);
        addLuaSprite('BeachSky', false)

	makeLuaSprite('Land', 'stages/vee-funkin/Land', 500, 600);
        addLuaSprite('Land', false)

        makeAnimatedLuaSprite('BeachOcean', 'stages/vee-funkin/BeachOcean', -1500, 650)
	...
	objectPlayAnimation('BeachOcean', 'BeachOcean', true);
        ...
        makeAnimatedLuaSprite('Sylveon Beach', 'stages/vee-funkin/Sylveon Beach', 1700, 600)
	addAnimationByPrefix('Sylveon Beach','Sylveon Beach','Sylveon Beach', 24, true)
        addLuaSprite('Sylveon Beach',false);

	makeLuaSprite('BeachForeground', 'stages/vee-funkin/BeachForeground', -1000, 600);
