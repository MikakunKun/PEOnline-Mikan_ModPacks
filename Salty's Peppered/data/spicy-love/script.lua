function onCreate()
	...
	makeLuaSprite('lights1', 'RedUpsideDown', 0, -500);
	setObjectCamera('lights1', 'camHud')


	makeLuaSprite('lights2', 'PinkUpsideDown', 0, -600);
...
function onStartCountdown()
	...
	doTweenY('zefunk1', 'lights1', 0, 6, 'sineInOut')
...
function onTweenCompleted(tag) --it loops the funny colors
	if tag == 'zefunk1' then doTweenY('zefunk2', 'lights1', 100, 4, 'sineInOut') end
	if tag == 'zefunk2' then doTweenY('zefunk1', 'lights1', 0, 4, 'sineInOut') end
	if tag == 'zefunk3' then doTweenY('zefunk4', 'lights2', 300, 2, 'sineInOut') end
