characterPath = 'characters/Itsumi_Week4' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'charBFExtra1' -- Set this to what the sprite should be named.
...
objectOrder = 3 -- Normally, values over 7 go over GF (3), Dad (4) and BF (5). (Default: 9)
...
characterFPS = 20 -- Default is 24, how many frames should the animation play?
...
animSuffix = '-sky' -- If this variable is set as '-alt', it will play alt animations. (Animation suffixes)
...
--]]
animationData = {
    ['idle'] = {'paste dance left', -1000, 0, '', false},

    ['danceLeft'] = {'itsumi dance right', 0, 0, '', false},
    ['danceRight'] = {'itsumi dance left', 0, 0, '', false},
    ['danceLeft-sky'] = {'itsumi sky', 0, 0, '0,1,2,3,3,4,5,6,7,7,8,6,7,8,6,7,8', false},
    ['danceRight-sky'] = {'itsumi sky', 0, 0, '0,1,2,3,3,4,5,6,7,7,8,6,7,8,6,7,8', false},
}
...
characterScales = {
    0.95, -- Scale X of character
    0.95 -- Scale Y of character
}
