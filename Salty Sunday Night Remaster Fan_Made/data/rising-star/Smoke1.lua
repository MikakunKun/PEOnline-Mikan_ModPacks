...
idle_xml_name = 'smoke idle'
--left_xml_name = 'ava left'
--down_xml_name = 'ava down'
--up_xml_name = 'ava up'
--right_xml_name = 'ava right'
...
name_of_character_xml = 'smoke1'
name_of_character = 'smoke1'
--name_of_notetype = 'ava'
--name_of_notetype2 = 'soporta' -- you don't need this, but if you want a notetype that has multiple characters to sing you can use this.
...
function onCreate()
	...
	addAnimationByPrefix(name_of_character, 'idle', idle_xml_name, 14, true);
	...
	objectPlayAnimation(name_of_character, '');
...
function onBeatHit()
	...
	if doIdle == true then
		objectPlayAnimation(name_of_character, '', true);
