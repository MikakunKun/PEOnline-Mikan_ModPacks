characterPath = 'characters/Speakers' -- Picture File name of spreadsheet (must have .xml)
...
animSuffix = '-alt' -- If this variable is set as '-alt', it will play alt animations. (Animation suffixes)
...
--]]
animationData = {
    ['idle'] = {'GF Dancing Beat', -1000, 0, '', false},
    ['idle-alt'] = {'GF Dancing Beat', -5, 0, '0, 1, 2, 3', false},

    ['danceLeft'] = {'GF Dancing Beat', -10000, 0, '0, 1, 2, 3', false},
    ['danceRight'] = {'GF Dancing Beat', -10000, 0, '0, 1, 2, 3', false},
    ['danceLeft-alt'] = {'GF Dancing Beat', -5, 0, '0, 1, 2, 3', false},
    ['danceRight-alt'] = {'GF Dancing Beat', -5, 0, '0, 1, 2, 3', false},
}
