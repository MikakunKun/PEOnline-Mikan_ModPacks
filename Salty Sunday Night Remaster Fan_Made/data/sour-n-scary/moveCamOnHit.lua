...
--customize variables
local camOffset = 35; -- how much will it move
...
function startScript()
    oppCamX = getProperty('dad.cameraPosition[0]') + getMidpointX('dad') + 200;
    oppCamY = getProperty('dad.cameraPosition[1]') + getMidpointY('dad') - 120
    bfCamX = getProperty('boyfriend.cameraPosition[0]') + getMidpointX('boyfriend') - 300;
    bfCamY = getProperty('boyfriend.cameraPosition[1]') + getMidpointY('boyfriend') - 150;
    pissed = true
end
